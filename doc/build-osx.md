Mac OS X checoind build instructions
====================================
...
1. Clone the github tree to get the source code and go into the directory.
        ...
        git clone git@github.com:checoin-project/checoin.git checoin
        cd checoin
...
A checoind binary is not included in the Litecoin-Qt.app bundle. You can ignore
...
commands:
    ...
    echo -e "rpcuser=checoinrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/Litecoin/checoin.conf"
    chmod 600 "/Users/${USER}/Library/Application Support/Litecoin/checoin.conf"
